            ...
            <div class="item">
                ...
                <div class="right">
                    ...
                    <div class="meta">
                        ...
                        <a href="javascript:void(0);" no-pjax onclick="return TypechoComment.reply('<?php $comments->theId(); ?>', <?php $comments->coid(); ?>)">
...
<div id="j-comment" class="j-comment" data-respondId="<?php $this->respondId() ?>">
            ...
            <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form">
                <div class="head">
                    <?php if ($this->user->hasLogin()) : ?>
                        <div class="head-item">
                            <input id="comment-nick" type="text" value="<?php $this->author->screenName(); ?>" autocomplete="off" name="author" maxlength="16" placeholder="昵称：请输入昵称（必填）" />
                        </div>
                        <div class="head-item">
                            <input id="comment-mail" type="text" value="<?php $this->author->mail(); ?>" autocomplete="off" name="mail" placeholder="QQ邮箱：请输入QQ邮箱（必填）" />
                        </div>
                    <?php else : ?>
                        <div class="head-item">
                        ...
                        <div class="head-item">
                            <input id="comment-mail" type="text" value="<?php $this->remember('mail'); ?>" autocomplete="off" name="mail" placeholder="QQ邮箱：请输入QQ邮箱（必填）" />
                        </div>
                    <?php endif; ?>
                    <div class="head-item">
                        <input type="text" value="<?php $this->remember('url'); ?>" autocomplete="off" name="url" placeholder="网址：请输入网址（选填）" />
                    </div>
                </div>
                <div class="content" id="commentTypeContent">
                    <textarea name="text" autocomplete="off" id="comment-content" rows="5" placeholder="说点什么吧，点击右上角可切换成画图模式哦~"></textarea>
