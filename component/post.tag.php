    ...
    <section class="handle">
        ...
        <section class="share">
            ...
            <section class="j-dropdown">
                <a no-pjax target="_blank" href="//connect.qq.com/widget/shareqq/index.html?url=<?php $this->permalink() ?>&title=<?php $this->title() ?>&pics=<?php GetRandomThumbnail($this) ?>">分享到QQ</a>
                <a no-pjax target="_blank" href="//service.weibo.com/share/share.php?title=分享：<?php $this->title() ?>，原文链接：<?php $this->permalink() ?>">分享到微博</a>
