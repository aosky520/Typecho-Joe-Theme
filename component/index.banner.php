        ...
        <?php if ($this->options->JIndexCarousel) : ?>
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    ?>
                        <a title="<?php echo $title ?>" href="<?php echo $url ?>" class="swiper-slide">
                            <img class="lazyload" src="//cdn.jsdelivr.net/npm/typecho_joe_theme@<?php echo JoeVersion() ?>/assets/img/lazyload.jpg" data-original="<?php echo $img ?>">
